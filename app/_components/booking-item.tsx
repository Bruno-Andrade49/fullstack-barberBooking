            ...
            <SheetTrigger asChild>
                <Card className="min-w-full">
                    <CardContent className="flex flex-row py-0 px-0">
                        ...
                        <div className="flex flex-col items-center justify-center border-l border-solid border-secondary px-3 flex-1">
            ...
            <SheetContent className="px-0">
                ...
                <div className="px-5">
                    <div className="relative h-[180px] w-full mt-6">
                        <Image src={"/img/CardMap.png"} fill style={{
                            objectFit: "cover", border: "1px solid transparent", borderRadius: "15px",
                    ...
                    <Badge className="w-fit mt-3 mb-6" variant={isBookingConfirmed ? "default" : "secondary"}>
                        {
                            isBookingConfirmed ? "Confirmado" : "Finalizado"
                        }
                    </Badge>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent className="w-[90%]">
                                ...
                                <AlertDialogFooter className="flex flex-row gap-3">
                                    ...
                                    <AlertDialogAction disabled={isDeleteLoading} className="w-full" onClick={handleCancelBookingClick}>
                                        {isDeleteLoading && (
                                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                                        )}
                                        Confirmar
